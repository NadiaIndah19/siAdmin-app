...
<div class="card">
  <div class="card-header d-flex align-items-center justify-content-between">
    ...
    <a href="{{ url('pelayanan/imb/create-imb') }}" type="button" class="btn btn-outline-primary">+&nbsp; Tambah Data</a>
  </div>
          ...
          {{-- <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ url('pelayanan/imb/view-imb') }}"><i class="bx bx-show-alt me-1"></i> View</a>
                <a class="dropdown-item" href="{{ url('pelayanan/imb/update-imb') }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
