...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Pelayanan /</span> KKS 
</h4>

<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      <li class="nav-item"><a class="nav-link" href="{{url('pelayanan/kks/create-kks')}}"><i class="bx bx-user me-1"></i>Tambah Data</a></li>
    ...
    <div class="card mb-4">
      <h5 class="card-header">Update KKS</h5>
      <hr class="my-0">
      <div class="card-body">
        <form id="formAccountSettings" method="POST" onsubmit="return false">
          <div class="row">
            <div class="mb-3 col-md-6">
              ...
              <input class="form-control" type="text" id="namepen" name="namepen" value="31213423453232" autofocus disabled/>
            </div>
            <div class="mb-3 col-md-6">
              <label for="name" class="form-label">Nama Kepala Keluarga</label>
              <input class="form-control" type="text" id="name" name="name" value="Albert Cook" disabled/>
            </div>
            <div class="mb-3 col-md-6">
              <label for="address" class="form-label">Alamat</label>
              <input type="text" class="form-control" id="address" name="address" value="Kutorejo No23 RT 02 RW 01" disabled/>
            </div>
            <div class="mb-3 col-md-6">
              <label for="jml_kel" class="form-label">Jumlah Anggota Keluarga</label>
              <input type="text" class="form-control" id="jml_kel" name="jml_kel" value="6" disabled/>
            </div>
            <div class="mb-3 col-md-6">
