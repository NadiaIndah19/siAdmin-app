          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" name="nik" class="form-control" id="basic-icon-default-nik" aria-describedby="basic-icon-default-nik2" required/>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <div class="input-group input-group-merge">
                <input class="form-control" name="tanggal_lahir" type="date" value="2021-06-18" id="html5-tgl-input" required/>
              </div>
            </div>
          </div>
          <div class="row">
