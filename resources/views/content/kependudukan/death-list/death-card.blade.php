...
<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-3">
      ...
      <li class="nav-item"><a class="nav-link" href="{{url('kependudukan/birth-card')}}"><i class="bx bx-bell me-1"></i> Kelahiran</a></li>
      <li class="nav-item"><a class="nav-link" href="{{url('kependudukan/marriage-card')}}"><i class="bx bx-link-alt me-1"></i> Pernikahan</a></li>
    </ul>
    <div class="card mb-4">
