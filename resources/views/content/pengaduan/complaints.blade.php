                ...
                <tbody class="table-border-bottom-0">
                  ...
                  ?>
                    @foreach ($pengaduan as $item)
                        ...
                        {{-- ================== MODAL LAMPIRAN ======================================= --}}
                        <div class="modal fade" id="lampiran{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">        
                                  <iframe src="{{ asset('storage/' . $item->lampiran) }}" width="100%" height="400px"></iframe>        
                              </div>
