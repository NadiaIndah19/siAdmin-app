...
class KKController extends Controller
{
  ...
  public function storeChild(Request $request, $id)
  {
    ...
    return redirect()->route('kk.anak', ['id' => $id])->with('success-create', 'Berhasil Menambahkan Data');
  }
  ...
  public function updateChild(Request $request, $id)
  {
    ...
    return redirect()->route('kk.anak', ['id' => $kk->kk_id])->with('success-create', 'Berhasil Menambahkan Data');
  }
